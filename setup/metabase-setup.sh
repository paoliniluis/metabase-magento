...
# creating a postgres
curl -s -X POST http://$1/api/database -H 'Content-Type: application/json' --cookie "metabase.SESSION=$sessionToken" --data '{"is_on_demand":false,"is_full_sync":false,"is_sample":false,"cache_ttl":null,"refingerprint":false,"auto_run_queries":true,"schedules":{},"details":{"host":"mariadb","port":3306,"dbname":"metabase","user":"metabase","password":"mysecretpassword","ssl":false,"tunnel-enabled":false,"advanced-options":true,"json-unfolding":false,"additional-options":"","let-user-control-scheduling":false},"name":" magento","engine":"mysql"}' && \
